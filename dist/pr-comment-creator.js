...
exports.PRCommentCreator = void 0;
exports.createPRCommentRequests = createPRCommentRequests;
exports.createPRCommentCreator = createPRCommentCreator;
exports.createPRComments = createPRComments;
...
class PRCommentCreator {
     ...
     */
    async createCommentWithRetry(request) {
        let lastError = '';
     ...
     */
    formatCommentBody(originalContent, originalComment) {
...
exports.PRCommentCreator = PRCommentCreator;
/**
 * Helper function to create PR comments from extracted comment data
 */
function createPRCommentRequests(processedFiles) {
    const requests = [];
